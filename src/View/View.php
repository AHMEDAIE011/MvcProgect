...
class View
{
    ...
    protected static function getBaseContent()
    {
        ...
        include view_path().'site/layouts/main.php';

        return ob_get_clean();
    }

    public static function makeAdmin($view, $params = [])
    {
        $baseContent = self::getBaseContentadmin();
    ...
    protected static function getBaseContentadmin()
    {
        ob_start();

        include view_path().'admin/layouts/main.php';
